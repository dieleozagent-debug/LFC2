...
|:---:|:---:|:---:|:---:|:---|:---|
| **R-135** | Técnico | Alta | Alto | Dependencia AT3 para especificaciones PTC en sistema CCTV | Desarrollar sistema CCTV basado en PTC Virtual (FRA 236) hasta disponibilidad de AT3 |
...
1. **Interfaces Críticas PTC:** Sistema CCTV para control embarcado PTC Virtual (FRA 236) hasta AT3
...
1. **Falta de interfaces PTC:** Agregado sistema CCTV específico para control embarcado PTC Virtual (FRA 236)
...
1. **Estrategia PTC:** Desarrollar sistema CCTV basado en PTC Virtual (FRA 236) hasta disponibilidad de AT3
