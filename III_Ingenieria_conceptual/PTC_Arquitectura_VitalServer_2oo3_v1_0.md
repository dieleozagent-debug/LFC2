...
### 1.1 Propósito
Este documento especifica la arquitectura del **Vital PTC Server** para el sistema de control de trenes del proyecto. Este componente es el cerebro de la seguridad vital, encargado de gestionar las autoridades de movimiento en modo **Virtual Fixed Block §236.1005**.
