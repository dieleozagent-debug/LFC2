...
- **29_Sistema_Senalización_Integrado.md** ⏳ (Filosofía virtual)
...
1. **29_Sistema_Senalización_Integrado.md** - Filosofía virtual
2. **27_Sistema_TETRA_Integrado.md** - 37 estaciones
3. **32_Material_Rodante_Integrado.md** - Sistema EOT
4. **V.1_Senalizacion_Ferroviaria_Detalle.md** - Eliminar Puntos de Referencia Virtuales (SICC)
...
- **V.1_Senalizacion_Ferroviaria_Detalle.md** ⏳ (Eliminar Puntos de Referencia Virtuales (SICC))
...
#### **4.2.1 Sistema PTC Embarcado (15 Locomotoras)**
**Funcionalidades:**
...
- 1.3.1 Diseno detallado de pasos a nivel (9 Tipo C + 15 Tipo B)
- 1.3.2 Sistemas de barreras automáticas (Tipo C)
- 1.3.3 Senalización vial integrada (Tipo B y C)
- 1.3.4 Sistemas de drenaje específicos
- 1.3.5 Pavimentación y accesos
- **NOTA:** 122 pasos Tipo A NO incluidos (solo senalización fija)
...
#### **3.1 CTC y Senalización Virtual**
- 3.1.1 Sistema CTC centralizado (CCO La Dorada)
- 3.1.2 Senalización virtual en cabinas (Display maquinista)
...
**Próximo paso:** Actualizar 29_Sistema_Senalización_Integrado.md (Capa 2 - Documentos conceptuales)
