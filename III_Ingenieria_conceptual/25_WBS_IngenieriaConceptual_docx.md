...
| 6.1 | Sistema de Alimentación Principal y Respaldo | - Diseno de doble acometida eléctrica<br>- Diagramas unifilares generales<br>- Especificaciones de tableros y transformadores<br>- Cumplimiento RETIE | `V_Ingenieria_detalle/7_Instalaciones_el_ctricas_Contrato_8_7.md` |
...
| 6.4 | Puesta a Tierra y Protección contra Rayos | - Diseno de malla de puesta a tierra (talleres, CCO, torres)<br>- Especificaciones de sistema de apantallamiento<br>- Cumplimiento NTC 2050 y RETIE | `V_Ingenieria_detalle/7_Instalaciones_el_ctricas_Contrato_8_7.md` |
