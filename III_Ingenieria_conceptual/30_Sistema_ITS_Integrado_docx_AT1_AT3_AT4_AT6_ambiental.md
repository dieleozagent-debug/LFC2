...
- **Gobierna a:**
    - `V_Ingenieria_detalle`: El diseno de detalle de los sensores y la plataforma ITS se basa en este concepto.
...
|---|---|
| `V_Ingenieria_detalle` | Requiere la arquitectura funcional y las especificaciones de los sensores ITS. |
