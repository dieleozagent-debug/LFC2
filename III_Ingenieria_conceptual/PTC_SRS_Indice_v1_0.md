...
**Sistema:** PTC Virtual (Virtual Fixed Block §236.1005)  
...
- **RF-001:** El sistema debe generar Autoridades de Movimiento (MA) basadas en la ocupación dinámica de vía (**Virtual Fixed Block §236.1005**).
