...
- **V.1_Senalización_Ferroviaria_Detalle.md** ⏳ (Alimentación virtual)
...
2. **V.1_Senalización_Ferroviaria_Detalle.md** - Alimentación virtual
...
- **CTC ↔ Sistemas Virtuales:** Alimentación para sistemas de senalización virtual
- **CTC ↔ ENCE:** Alimentación para 5 enclavamientos electrónicos
- **CTC ↔ TETRA + Red Vital IP / TETRA:** Alimentación para 37 estaciones de cada sistema
...
**Funcionalidades:**
- Alimentación para senalización virtual
...
- **Senalización virtual** en cabinas
- **Eliminación de alimentación física**
...
| **TS-3 (Comunicaciones)** | 80 kVA | TETRA, Red Vital IP / TETRA, Fibra, VSAT | Sala de telecomunicaciones |
...
- **Alimentación senales físicas:** -$1,500,000,000 COP
- **Alimentación Puntos de Referencia Virtuales (SICC):** -$800,000,000 COP
...
- **TETRA + Red Vital IP / TETRA:** +$400,000,000 COP (74 estaciones total)
...
- ✅ Eliminación de alimentación senales físicas
- ✅ Eliminación de alimentación Puntos de Referencia Virtuales (SICC)
