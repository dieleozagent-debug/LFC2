...
2. **V.3_Sistemas_Comunicacion_Detalle.md** - Red Vital IP / TETRA agregado
...
2. Documentos de ingeniería basica y detalle
...
- Zonas montanosas (40%): 60m altura × 15 torres = 15 torres reforzadas
...
#### **7.1.3 Sistema Red Vital IP / TETRA (37 Estaciones) - NUEVO**
**Estaciones Base Red Vital IP / TETRA**
- 37 Estaciones base Red Vital IP / TETRA (colocalizadas con TETRA)
- 3 Estaciones base redundantes (backup crítico)
- 2 Estaciones base CCO (principal + respaldo)
- **ESTIMACIÓN:** **42 Equipos Estación Base Red Vital IP / TETRA**

**Radios Red Vital IP / TETRA Embarcados**
- Radios Red Vital IP / TETRA embarcados locomotoras: 15 unidades
- Radios Red Vital IP / TETRA portátiles mantenimiento: 30 unidades
- Radios Red Vital IP / TETRA vehículos de inspección: 15 unidades
- **ESTIMACIÓN:** **60 Equipos de Radio Red Vital IP / TETRA**

#### **7.1.4 Consumo Eléctrico TETRA + Red Vital IP / TETRA**
**Por Estación Base**
- Potencia estación base TETRA: 500W
- Potencia estación base Red Vital IP / TETRA: 300W
- Climatización caseta: 3 kW
- Iluminación/auxiliares: 500W
- Total por sitio: 4.3 kW

**Total Sistema TETRA + Red Vital IP / TETRA**
...
- Estaciones TETRA + Red Vital IP / TETRA: 37 × 6 kVA = 222 kVA UPS  
...
**Torres TETRA + Red Vital IP / TETRA**
- 37 torres × 2,500 m² promedio = 92,500 m²
- Servidumbres acceso: 37 × 500 m² = 18,500 m²
- Total predial TETRA + Red Vital IP / TETRA: 111,000 m² (11.1 hectáreas)
...
**TETRA + Red Vital IP / TETRA (ANE - Agencia Nacional Espectro)**
...
| **Torres TETRA + Red Vital IP / TETRA** | Meses 20-32 | Permisos ANE |
| **Tendido fibra** | Meses 28-34 | Ductos terminados |
| **Equipos TETRA + Red Vital IP / TETRA** | Meses 30-36 | Torres listas |
| **Pruebas integración** | Meses 34-36 | Todos los sistemas |

#### **7.5.2 Ruta Crítica**
**GESTIÓN PREDIAL → PERMISOS → DUCTOS → FIBRA → INTEGRACIÓN**
(El TETRA + Red Vital IP / TETRA puede ir en paralelo una vez liberados predios)
...
| **Estaciones Base Red Vital IP / TETRA** | 42 | 120,000 | 5,040,000 |
...
- Mantenimiento TETRA + Red Vital IP / TETRA: USD 800,000/ano
- Mantenimiento Fibra: USD 400,000/ano  
- Energía eléctrica: USD 200,000/ano
- Personal especializado: USD 350,000/ano
- Seguros y licencias: USD 120,000/ano

**TOTAL OPEX:** USD 1,870,000/ano
...
**Sistema TETRA + Red Vital IP / TETRA**
...
1. Estudio propagación radio (TETRA + Red Vital IP / TETRA): Drive test 526.133 km
2. Estudio geotécnico: fundaciones torres + casetas
3. Análisis interferencias: EMC entre TETRA, Red Vital IP / TETRA y fibra
...
2. Sites alternativos TETRA + Red Vital IP / TETRA (problemas prediales)
...
- **Responsable:** Administrador Contractual EPC
- **Impacto presupuestal:** +$15,114,000,000 COP (TETRA + Red Vital IP / TETRA + Fibra)
