...
- **Nota técnica:** Queda prohibida la inclusión del procedimiento "Handover Digital (Digital Gateway)" en esta sección.
...
| **Legacy** | **PROHIBIDO** | **ELIMINAR Handover Digital (Digital Gateway)** |

---

## 🔍 CONCLUSIONES DE SANEAMIENTO
- ❌ **ELIMINADO:** El protocolo "Handover Digital (Digital Gateway)" de la tabla de interoperabilidad de plantillas.
