...
- **Control:** Servidor Maestro PTC 2oo3 (Reemplaza al RBC y protocolos propietarios).
- **Comunicaciones:** Red de Misión Crítica **TETRA** y Fibra Óptica (Purga total de GSM-R).
...
- ✅ **ELIMINADO:** Hardware de vía (Eurobalises, Señales LED, Circuitos de vía).
- ✅ **ELIMINADO:** Infraestructura de radio europea (GSM-R).
- ✅ **ELIMINADO:** Protocolos cerrados (FFFIS, UNISIG, ITCS Alstom).
...
- ✅ **CORREGIDO:** El tablero de control (DMI) no busca portadoras GSM-R; opera nativamente sobre TETRA.
- ✅ **CORREGIDO:** Las rutinas de mantenimiento preventivo de vía ya no incluyen "Limpieza de Balizas", sino "Inspección de Nodos de Red IP".
- ✅ **CORREGIDO:** La matriz de riesgos elimina la "Dependencia de AT3 para ITCS". Los riesgos ahora son puramente de ciberseguridad y estabilidad de la red IP/Vital.
...
|:---|:---|:---|
| **Señalización Virtual** | 99.95% | Vital IP |
