...
- **Canal Seguro:** Se utiliza la red **TETRA** con encriptación nativa para todo el tráfico de seguridad. Se elimina el GSM-R.
...
## 2. 🔍 AUDITORÍA DE SANEAMIENTO (PURGE GSM-R/RBC)

En cumplimiento del **Ciclo Inverso**, se han corregido los siguientes desvíos operativos de la v5.0:
- ✅ **ELIMINADO:** Menciona a "Comunicaciones GSM-R seguras". La seguridad ahora es agnóstica a la capa física, centrada en el protocolo **Vital IP**.
- ✅ **ELIMINADO:** Rutinas de seguridad física para RBC y Balizas. La seguridad es peer-to-peer (Tren-Servidor PTC).
