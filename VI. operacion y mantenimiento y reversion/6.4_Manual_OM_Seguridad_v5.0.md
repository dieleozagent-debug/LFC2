...
- **ATP Embarcado:** El control de seguridad reside en la OBC, que valida las Autorizaciones de Movimiento (MA) recibidas vía **Vital IP**.
- **Canal Seguro:** Se utiliza la red **TETRA** con encriptación nativa para todo el tráfico de seguridad. Se elimina el RED TETRA (Misión Crítica).
...
## 2. 🔍 AUDITORÍA DE SANEAMIENTO (PURGE RED TETRA (Misión Crítica)/RBC)

En cumplimiento del **Ciclo Inverso**, se han corregido los siguientes desvíos operativos de la v5.0:
- ✅ **ELIMINADO:** Menciona a "Comunicaciones RED TETRA (Misión Crítica) seguras". La seguridad ahora es agnóstica a la capa física, centrada en el protocolo **Vital IP**.
- ✅ **ELIMINADO:** Rutinas de seguridad física para RBC y Punto de referencia virtuals. La seguridad es peer-to-peer (Tren-Servidor PTC).
