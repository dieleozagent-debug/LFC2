...
La operación del Centro de Control de Tráfico (CTC) se basa en la arquitectura **PTC Virtual** (FRA 236). Se elimina toda dependencia de infraestructuras de radio europeas (RED TETRA (Misión Crítica)) o protocolos propietarios (PTC).
...
- ✅ **ELIMINADO:** Verificación de 37 estaciones RED TETRA (Misión Crítica). El check-list de inicio se unifica en el estado de la red TETRA.
- ✅ **ELIMINADO:** Procedimientos de "conmutación dual" (TETRA/RED TETRA (Misión Crítica)). El sistema es nativo TETRA.
