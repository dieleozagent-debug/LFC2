...
- **Sin Eurobalizas:** El posicionamiento es virtual/GNSS. Se elimina cualquier rutina de mantenimiento para balizas físicas.
- **Sin Señales LED:** El "aspecto" de la señalización es virtual y se muestra exclusivamente en el display (DMI) de la cabina.
...
- ✅ **ELIMINADO:** Rutinas de mantenimiento para el subsistema GSM-R. Toda la telemetría de señalización viaja por TETRA.
- ✅ **ELIMINADO:** Referencias a "Eurobalises y LEUs". Se purga el check-list de inspección de vía de hardware electrónico.
