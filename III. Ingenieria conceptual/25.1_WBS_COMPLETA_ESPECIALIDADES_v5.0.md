...
- 2.2.2 UPS para sistemas de comunicaciones (TETRA + RED TETRA (Misión Crítica))
...
#### **4.2 Sistema RED TETRA (Misión Crítica) (37 Estaciones) - NUEVO**
- 4.2.1 Red RED TETRA (Misión Crítica) redundante (37 estaciones base)
- 4.2.2 Colocalización con TETRA (misma torre)
- 4.2.3 Radios RED TETRA (Misión Crítica) embarcados (30 unidades)
- 4.2.4 Antenas RED TETRA (Misión Crítica) colocalizadas
- 4.2.5 Sistema de control RED TETRA (Misión Crítica) centralizado
...
- 5.1.4 Sistemas de comunicación embarcados (TETRA + RED TETRA (Misión Crítica))
