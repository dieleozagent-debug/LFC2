...
El contrato exige instalar sistemas de señalización y detección de ocupación compatibles con CTC y basados en normas internacionales (FRA/AREMA/AREMA), dejando al diseno la selección y dimensionamiento (circuitos de vía y/o contadores de ejes), con integración al CTC del proyecto.
...

👉 En conclusión:Sí, el contrato obliga a implementar una red continua de señalización y control basada en fibra óptica y respaldo TETRA, donde cada tramo de vía y estación tendrá controladores que alimentan señales, cambios de aguja, detectores y pasos a nivel. El diseno debe asegurar redundancia eléctrica (red + plantas + baterías) y redundancia de comunicaciones (fibra + TETRA).
