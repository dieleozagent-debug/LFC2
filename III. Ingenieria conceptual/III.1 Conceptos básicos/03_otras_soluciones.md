...
Este documento justifica la decisión técnica de abandonar el estándar propietario ITCS (Alstom) y el estándar europeo ETCS Level 2 en favor del **PTC Virtual (FRA 236)**.
...
3.  **Optimización de Activos:** Eliminación de eurobalizas físicas y señales laterales, reduciendo el CAPEX en un 40-60%.
...
- **GNSS de Alta Precisión** para localización vital sin balizas.
...
| Métrica | PTC Virtual | ITCS Alstom | Estado |
|:---|:---:|:---:|:---:|
| **Dependencia** | Estándar Abierto | Propietario | 🟢 SANEADO |
| **Costo Operativo**| Bajo (TETRA/IP) | Alto (GSM-R/UIC) | 🟢 SANEADO |
