...
- **Gobierna a:**
    - `V. Ingenieria de detalle/2_Centro_de_Control_de_Tr_fico_CTC_Contrato_8_2.md`: El diseno de detalle se basa en los conceptos aquí definidos.
...
- **Diseno Modular:** El CTC se diseñará con una interfaz de "caja negra" (API bien definida) para el sistema PTC. Esto permite desarrollar el 90% del CTC (supervisión, enclavamientos, gestión de surcos) de forma independiente.
