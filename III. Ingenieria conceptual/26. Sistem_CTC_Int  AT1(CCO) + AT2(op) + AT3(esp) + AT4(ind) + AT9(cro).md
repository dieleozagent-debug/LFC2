...
- **Diseño Modular:** El CTC se diseñará con una interfaz de "caja negra" (API bien definida) para el sistema PTC. Esto permite desarrollar el 90% del CTC (supervisión, enclavamientos, gestión de surcos) de forma independiente.
- **Enfoque en Supervisión:** Inicialmente, el CTC se centrará en la supervisión de la posición de los trenes (vía GPS/TETRA) y el control de la señalización enclavada, sin depender de las funciones de "enforcement" del PTC.
...
- **🚂 Estrategia PTC PTC VIRTUAL Level 2:** Se utilizará PTC VIRTUAL Level 2 como estándar internacional de referencia hasta que AT3 esté disponible, asegurando compatibilidad y interoperabilidad.
...
| **Control Positivo de Trenes (PTC)** | AT3, Cap. 8.10 | Interfaz para recibir datos del PTC y enviar autorizaciones de movimiento. Funciones de "enforcement" bloqueadas.<br>- **PTC PTC VIRTUAL Level 2 hasta AT3** | 🔴 Bloqueado |
...
- **🔴 Rojo (Bloqueado):** Funciones de "enforcement" (frenado automático), señalización en cabina, optimización avanzada de tráfico basada en PTC.
...
1. **🚂 PTC PTC VIRTUAL Level 2:** Estrategia de avance con PTC VIRTUAL Level 2 como estándar hasta AT3
...
- ✅ **PTC:** Estrategia PTC VIRTUAL Level 2 especificada en diseño modular
...
| **R-034** | **Gestión de interfaces** | **Técnico** | **Media** | **Medio** | Múltiples interfaces críticas (Señalización, PTC, FENOCO) |
