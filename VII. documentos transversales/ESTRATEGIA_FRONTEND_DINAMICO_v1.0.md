...
## 🎯 Objetivo
Eliminar el 100% del código "zombie" (ETCS, GSM-R, Balizas) en la UI y asegurar que cualquier cambio en el `project_config.json` se refleje en toda la web sin intervención manual.
...
- **Resultado:** Eliminación de campos obsoletos (ej. "Validación Eurobaliza") y sustitución por "Fusión GNSS/IMU" o "Vital IP Status".
