...
- **Sistemas de Comunicación:** Integración con TETRA y Red Vital IP / TETRA
...
- **Comunicaciones Inalámbricas:** TETRA + Red Vital IP / TETRA para sistemas móviles
...
| **ITS** | **Red Vital IP / TETRA** | Datos | GPRS/4G | ✅ Implementado |
