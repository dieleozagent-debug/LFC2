...
Se realiza una optimización radical del CAPEX eliminando la red GSM-R. 
...
## 2. 🔍 AUDITORÍA DE SANEAMIENTO (PURGE ETCS/GSM-R)
En cumplimiento del **Ciclo Inverso**, se han eliminado las siguientes memorias obsoletas:
1.  ❌ **ELIMINADO:** Memorias de cálculo de Eurobalizas (0 unidades).
2.  ❌ **ELIMINADO:** Memorias de cobertura GSM-R (Sustituido por TETRA).
