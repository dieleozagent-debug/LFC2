...
1. **🚂 INTEGRACIÓN PTC PTC Virtual (FRA 236) EN REVERSIÓN DE BIENES:**
   - **Reversión de equipos PTC:** Entrega de equipos PTC PTC Virtual (FRA 236) embarcados
...
1. **Falta de especificaciones PTC en reversión:** Agregado inventario y documentación de equipos PTC Virtual (FRA 236)
...
|:---|:---|:---|:---|:---:|
| **PTC Reversión** | 15.1 | AT3 | PTC Virtual (FRA 236) | ✅ Implementado |
| **FENOCO Reversión** | 15.1 | AT1 | Protocolos FRA/AREMA | ✅ Implementado |
...
1. **Estrategia de Avance con Bloqueos PTC:**
   - **Fase 1:** Preparación de reversión con PTC Virtual (FRA 236) (0-6 meses)
...
|:---|:---:|:---:|:---|:---:|
| **PTC PTC Virtual (FRA 236)** | 100% inventariado | Mensual | Ing. Sistemas | 🟢 En progreso |
...
1. **Inmediato (0-6 meses):**
   - Preparar inventario de equipos PTC PTC Virtual (FRA 236)
...
- **PTC PTC Virtual (FRA 236)** en proceso de reversión de bienes
