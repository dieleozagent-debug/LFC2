...
documentos_maestros_actualizar:
  - file: "VIII_Documentos_Maestros_Metodologia/CRITERIOS_TECNICOS_MAESTRO_v1.0.md"
  ...
  - file: "VIII_Documentos_Maestros_Metodologia/MATRIZ_TRAZABILIDAD_TECNICA_v1.0.md"
...
1. **`IX_WBS_Planificacion/cronograma_datos.json`**
2. **`IX_WBS_Planificacion/riesgos_wbs.json`**
3. **`IX_WBS_Planificacion/reporte_gerencial_justificaciones.json`**

### **Modificar HTML (3 archivos):**

1. **`IX_WBS_Planificacion/WBS_Cronograma_Propuesta.html`**
2. **`IX_WBS_Planificacion/WBS_Analisis_Riesgos.html`**
3. **`IX_WBS_Planificacion/WBS_Reporte_Gerencial.html`**
