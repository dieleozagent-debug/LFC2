...
- **64B COP sobrepresupuesto** por componentes eliminados (Puntos de Referencia Virtuales (SICC), Senalización en Cabina (Cab-Signaling), Servidor PTC Central)
...
- **Filosofía:** Senalización VIRTUAL (CTC + PTC embarcado)
...
2. Componentes eliminados (Puntos de Referencia Virtuales (SICC), Senalización en Cabina (Cab-Signaling), Servidor PTC Central)
