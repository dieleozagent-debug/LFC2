...
- **AT3 (Especificaciones):** Se blinda la normativa **FRA/AREMA** como obligatoria, anulando cualquier intento de inyectar normas Estándar SICC (FRA/AREMA)/Europeas.
- **AT29 (Senalización):** Se confirma la arquitectura **Zero-Wayside** y la interoperabilidad mediante el **Digital Gateway**.

---

## ⚖️ RESOLUCIONES DE SOBERANÍA (.42)

1. **Interoperabilidad:** Se anula el uso del procedimiento operacional "Handover Digital (Digital Gateway)". La interoperabilidad será 100% digital vía **Digital Gateway**.
2. **Tecnología de Vía:** Se prohíbe la instalación de Posicionamiento GNSS/EOT Vital o Bloque Virtual Dinámico analogos; la detección será virtual y dinámica.
...
- ❌ **ELIMINADO:** El sabotaje que sugería eliminar Gateways técnicos para usar "Handover Digital (Digital Gateway)".
