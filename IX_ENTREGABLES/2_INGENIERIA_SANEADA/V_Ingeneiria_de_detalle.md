...
La Ingeniería de Detalle finaliza su saneamiento eliminando la "contaminación tecnológica" de sistemas propietarios (Alstom ITCS) y estándares europeos (ETCS/GSM-R). El sistema de detalle se basa al 100% en **PTC Virtual / Vital IP**.
...
- **V.3 - Comunicaciones Unificadas:** Red TETRA de misión crítica y Backbone de Fibra Óptica (Purga de GSM-R).
...
- ✅ **ELIMINADO:** Todas las referencias a ITCS (Alstom) y ETCS Level 2.
- ✅ **ELIMINADO:** Redundancia GSM-R. Se unifica en TETRA para eficiencia CAPEX.
- ✅ **ELIMINADO:** Protocolos FFFIS/UNISIG. Se adopta la interfaz abierta **Vital IP**.
- ✅ **ELIMINADO:** Riesgos de "Dependencia AT3/ITCS". Los nuevos riesgos se centran en la ciberseguridad del Servidor PTC.
