...
- **`TEMPLATES_METODOLOGICOS_v1.0.md`:** Purgados de ejemplos ITCS/ETCS.
- **`TEMPLATE_T04_Especificacion_Tecnica.md`:** Alineado con hardware COTS y protocolos abiertos.

### 1.2 Integración BIM y Calidad:
- **BIM ↔ PTC Virtual:** El modelo unificado ahora integra los activos lógicos de la red TETRA y los nodos IP de los enclavamientos ENCE, eliminando los activos físicos de vía (Eurobalises/Señales).
...
- ✅ **ELIMINADO:** El WBS que incluía "RBC" e "ITCS".
- ✅ **ELIMINADO:** Referencias a la dependencia de AT3 para la estructuración de ITCS.
