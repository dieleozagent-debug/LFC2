...
Se descarta el uso de GSM-R. La seguridad en TETRA se basa en:
...
|:---:|:---:|:---|:---|
| **v2.0** | 13/03/2026 | Admin. Contractual | **RE-ESCRITURA TOTAL**. Eliminada seguridad GSM-R/Eurobalizas. Alineado con TETRA y FRA 236. |
| **v1.0** | 27/01/2025 | Ing. Ciberseguridad | Versión obsoleta basada en seguridad ETCS (HALLUCINATED). |
