...
1. **ELIMINADO ETCS Level 2:** Se reemplaza por procedimientos operativos **FRA/PTC**.
2. **ELIMINADO SCADA ERTMS:** El monitoreo se realiza mediante un SCADA simplificado integrado al SICC.
3. **MANTENIMIENTO:** Se elimina el mantenimiento de señales LED y balizas (Infraestructura inexistente).
...
|:------:|:-----------:|:-----------------------|:-----------------------------------------|
| v4.2   | 13/03/2026  | Admin. Contractual EPC | Purgado de ETCS/UIC. Alineación con ROT basado en PTC Virtual. |
