...
1. **ELIMINADO PTC VIRTUAL Level 2:** Se reemplaza por procedimientos operativos **FRA/PTC**.
2. **ELIMINADO SCADA ERTMS:** El monitoreo se realiza mediante un SCADA simplificado integrado al SICC.
...
|:------:|:-----------:|:-----------------------|:-----------------------------------------|
| v4.2   | 13/03/2026  | Admin. Contractual EPC | Purgado de PTC VIRTUAL/UIC. Alineación con ROT basado en PTC Virtual. |
