...
1. **ELIMINADO GSM-R:** Se elimina la mención a 37 estaciones GSM-R. El estándar de radio del contrato es **TETRA**.
2. **ELIMINADO ETCS/UIC:** Se eliminan referencias a niveles ETCS y normativas UIC no aplicables.
...
|:------:|:-----------:|:-----------------------|:-----------------------------------------|
| v6.0   | 13/03/2026  | Admin. Contractual EPC | Purgado de GSM-R y ETCS. Alineación con TETRA y PTC Virtual. |
