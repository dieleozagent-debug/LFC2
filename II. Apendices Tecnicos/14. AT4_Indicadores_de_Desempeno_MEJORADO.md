...
1. **ELIMINADO KPI BALIZAS ERTMS:** No existen balizas en el proyecto.
2. **ELIMINADO KPI SEÑALES WAYSIDE:** No hay señales físicas LED.
3. **AJUSTE TETRA:** Se elimina mención a GSM-R. El KPI de radio aplica solo a **TETRA**.
...
|:------:|:-----------:|:-----------------------|:-----------------------------------------|
| v4.2   | 13/03/2026  | Admin. Contractual EPC | Re-ingeniería de KPIs del SICC. Eliminación de métricas para activos inexistentes (ETCS/GSM-R). |
