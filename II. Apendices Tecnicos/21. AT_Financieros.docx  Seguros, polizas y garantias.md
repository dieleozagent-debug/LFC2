...
|:---:|:---:|:---|:---|:---:|
| **v1.0** | Sep-2025 | Versión inicial basica | Ing. Contractual | Histórica |
...
- **Etapa de Operación y Mantenimiento** (25 anos)
...
- **Danos contra todo riesgo obras civiles**
...
**O&M + REVERSIÓN:**
- 25 anos + tiempo adicional hasta liquidación del contrato
...
- Danos, pérdidas o deterioro de bienes, materias primas, equipos
- Productos terminados, incluyendo materiales peligrosos
- Cargue y descargue

**PARA TRANSPORTE DE PASAJEROS:**
- Danos y perjuicios causados a personas
...
- Si hay objeciones: ANI senala plazo de corrección ≤ **10 días hábiles**
...
| **Garantía Única O&M + Reversión** | 25 anos + liquidación | Prórrogas según contrato | Anual |
...
| **Procedimientos Operativos** | ✅ DETALLADOS | 100% | Optimizaciones EPC anadidas |
...
| **Optimizaciones EPC** | ✅ ANADIDAS | 100% | **Secciones 10.4 y 11 nuevas** |
...
1. **🚂 INTEGRACIÓN PTC PTC Virtual (FRA 236) EN SEGUROS Y GARANTÍAS:**
   - **Seguros PTC:** Cobertura de seguros para sistemas PTC PTC Virtual (FRA 236)
...
1. **Falta de seguros PTC:** Agregada cobertura de seguros para sistemas PTC PTC Virtual (FRA 236)
...
|:---|:---|:---|:---|:---:|
| **PTC Seguros y Garantías** | 8.1, 13.1 | AT3 | PTC Virtual (FRA 236) | ✅ Implementado |
...
1. **Estrategia de Avance con Bloqueos PTC:**
   - **Fase 1:** Contratar seguros PTC PTC Virtual (FRA 236) (0-3 meses)
...
|:---|:---:|:---:|:---|:---:|
| **PTC PTC Virtual (FRA 236)** | 100% cubierto | Diario | Ing. Sistemas | 🟢 En progreso |
...
1. **Inmediato (0-3 meses):**
   - Contratar seguros PTC PTC Virtual (FRA 236)
...
- **PTC PTC Virtual (FRA 236)** en seguros y garantías
