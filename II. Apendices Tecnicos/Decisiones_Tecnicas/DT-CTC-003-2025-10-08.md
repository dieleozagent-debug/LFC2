...
| **2. Módulo PTC VIRTUAL Level 2** | $25,000,000,000 | 28.4% |
...
- §3.1: "Sistema PTC VIRTUAL Level 2 para control de trenes"
...
2. **Módulos PTC VIRTUAL Level 2** incluyen certificación CENELEC completa
  ...
  - file: "IX. WBS y Planificacion/wbs_metadata_enriquecida.json"
    ...
    metadata_actualizar:
      ...
      criterios_diseno:
        ...
        - "Módulo PTC VIRTUAL Level 2: $25B - EVC + RBC + RED TETRA (Misión Crítica)/TETRA"
