...
- Interfaces RED TETRA (Misión Crítica) / TETRA
...
- Protocolo FFFIS (RED TETRA (Misión Crítica))
...
- Módulo FRA/AREMA 554 (Señalización)
...
- §3.4: "Interfaces RED TETRA (Misión Crítica) y TETRA para comunicaciones vitales"
  ...
  - file: "IX. WBS y Planificacion/wbs_metadata_enriquecida.json"
    ...
    metadata_actualizar:
      ...
      criterios_diseno:
        ...
        - "Módulo PTC Virtual (FRA 236): $25B - EVC + Servidor PTC Central + RED TETRA (Misión Crítica)/TETRA"
