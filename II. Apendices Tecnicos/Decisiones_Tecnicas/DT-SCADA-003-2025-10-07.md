...
**2. EQUIPOS CAPA 2 (SWITCHING) - $1,200M**
   - 50 switches industriales distribuidos
     - 37 en estaciones TETRA/RED TETRA (Misión Crítica)
...
└── Conexión MPLS a:
    ├── 37 Estaciones TETRA/RED TETRA (Misión Crítica) (switches L2)
...
- **Capítulo 1 (CTC/PTC):** Comunicación de señalización vía MPLS/QoS
