...
🔹 Por tanto, el contrato reconoce cinco (5) locomotoras en total equipadas con sistemas embarcados (ATP o PTC):
→ 2 GR12 + 2 U10 + 1 U18 = 5 ATP embarcadas.

Apéndice Técnico 1 (Cap. V y Anexo AT1-3)
Confirma el mismo universo de material tractivo (2 GR12, 2 U10, 1 U18) y detalla que cada una debe ser equipada con los sistemas de control a bordo requeridos (ATP/PTC).
