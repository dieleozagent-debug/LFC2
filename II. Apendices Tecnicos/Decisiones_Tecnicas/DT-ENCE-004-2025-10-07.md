...
2. `V. Ingenieria de detalle/V.2_Centro_Control_Trafico_CTC_v5.0.md` (Sección 4.6 - Senalización ENCE)
3. `III. Ingenieria conceptual/23_Centro_Control_Trafico_CTC_Integrado_v5.0.md` (Sección 3.5 - Senalización por estación)
