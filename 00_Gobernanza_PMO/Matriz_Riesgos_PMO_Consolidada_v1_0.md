...
**Fuente única:** `III_Ingenieria_conceptual/36.1_Analisis_Riesgos_y_Supuestos_PMI.md`

---

## 1. Referencias
- Roadmap: `@@Roadmap_v12.0_Marco_Gestion_Consolidado.md`
- Riesgos y Supuestos (PMO): `III_Ingenieria_conceptual/36.1_Analisis_Riesgos_y_Supuestos_PMI.md`
