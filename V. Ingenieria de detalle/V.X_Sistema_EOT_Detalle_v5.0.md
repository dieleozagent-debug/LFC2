...
- **Comunicaciones:** Enlace directo con la OBC de la locomotora vía **Radio TETRA**. Se elimina por completo el GSM-R.
...
- ✅ **ELIMINADO:** Redundancia GSM-R en la radio del EOT. Se unifica en TETRA.
- ✅ **ELIMINADO:** Requisitos de interoperabilidad con RBC o protocolos UNISIG.
- ✅ **ELIMINADO:** Cualquier referencia a costos o hardware "Eurobalise" en la lógica de posicionamiento de cola.
