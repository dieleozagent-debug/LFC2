...
- ✅ **ELIMINADO:** Redundancia GSM-R. La comunicación vital se unifica en la red TETRA de misión crítica.
- ✅ **ELIMINADO:** Asunción de costos para "Eurobalises" (Incluso como valor negativo, se purga la mención para evitar confusión).
- ✅ **ELIMINADO:** Protocolos FFFIS/UNISIG. El sistema habla **Vital IP**.
- ✅ **CORREGIDO:** El CAPEX se optimiza al eliminar el equipamiento GSM-R embarcado y de vía.
...
Este documento de ingeniería de detalle garantiza que no existan contradicciones con los documentos maestros. Al eliminar el "fantasma" del GSM-R y el ETCS, el proyecto asegura su soberanía tecnológica y eficiencia financiera.
