...
1. **🚂 INTEGRACIÓN PTC PTC VIRTUAL Level 2 EN ALCANCE DEL PROYECTO:**
   - **Alcance PTC:** Definición completa de sistemas PTC PTC VIRTUAL Level 2 en alcance
...
1. **Falta de especificaciones PTC en alcance:** Agregada definición completa de sistemas PTC PTC VIRTUAL Level 2
...
|:---|:---|:---|:---|:---:|
| **PTC Alcance** | 8.1, 13.1 | AT3 | PTC VIRTUAL Level 2 | ✅ Implementado |
...
1. **Estrategia de Avance con Bloqueos PTC:**
   - **Fase 1:** Definir alcance con PTC VIRTUAL Level 2 (0-3 meses)
...
|:---|:---:|:---:|:---|:---:|
| **PTC PTC VIRTUAL Level 2** | 100% especificado | Semanal | Ing. Sistemas | 🟢 En progreso |
...
1. **Inmediato (0-3 meses):**
   - Definir alcance PTC PTC VIRTUAL Level 2
...
- **PTC PTC VIRTUAL Level 2** en alcance del proyecto
