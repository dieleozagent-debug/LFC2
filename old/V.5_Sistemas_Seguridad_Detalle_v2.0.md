...
Este documento detalla la ingeniería de los **sistemas de seguridad colocalizada** para el proyecto APP La Dorada-Chiriguaná, basado en **seguridad dual para TETRA + Red Vital IP / TETRA colocalizados** en 37 torres con redundancia operacional.
...
└─────────────────────────────────────────────────────────────┘
                              ...
                              │ (Seguridad TETRA + Red Vital IP / TETRA)
                              ▼
┌─────────────────────────────────────────────────────────────┐
...
- **SIL 2:** Funciones de supervisión TETRA + Red Vital IP / TETRA
...
- **SIL 3:** TETRA + Red Vital IP / TETRA colocalizados, comunicaciones críticas
...
- **Comunicación:** TETRA + Red Vital IP / TETRA colocalizado, protocolo directo
...
- **Comunicación:** TETRA + Red Vital IP / TETRA seguro colocalizado
- **Monitoreo:** Supervisión continua colocalizada
...
- **PTC Embarcado:** Pruebas de seguridad embarcada
- **CTC Virtual:** Pruebas de seguridad virtual
- **TETRA + Red Vital IP / TETRA:** Pruebas de seguridad colocalizada
...
- **37 Torres Colocalizadas:** Seguridad TETRA + Red Vital IP / TETRA
