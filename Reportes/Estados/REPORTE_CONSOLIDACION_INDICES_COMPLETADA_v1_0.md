# REPORTE DE CONSOLIDACIÓN DE ÍNDICES COMPLETADA v1.0
...
- **I_Contrato_General:** 12 documentos
...
- **VII_Soporte_Especializado:** 14 documentos
- **Total:** 15 documentos

#### **GOBERNANZA Y GESTIÓN**
- **00_Gobernanza_PMO:** 1 documento
...
- **Roles y responsabilidades:** `00_Gobernanza_PMO/0.1_MATRIZ_ROLES_PMO_EPC_RACI.md`
- **WBS completa:** `III_Ingenieria_conceptual/25.1_WBS_COMPLETA_ESPECIALIDADES.md`
...
- **Senalización:** `V_Ingenieria_detalle/V.1_Senalizacion_Ferroviaria_Detalle_v1.0.md` ✅
- **CTC:** `V_Ingenieria_detalle/V.2_Centro_Control_Trafico_CTC_Detalle_v1.0.md` ✅
- **Comunicaciones:** `V_Ingenieria_detalle/V.3_Sistemas_Comunicacion_Detalle_v1.0.md` ✅
- **Potencia:** `V_Ingenieria_detalle/V.4_Sistemas_Potencia_Detalle_v1.0.md` ✅
- **Seguridad:** `V_Ingenieria_detalle/V.5_Sistemas_Seguridad_Detalle_v1.0.md` ✅
