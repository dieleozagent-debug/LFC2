...
| **Senalización LED** | Paneles, controladores, sincronización | Media-Alta |
...
| **3. Montaje equipos** | Barreras, Senalización en Cabina (Cab-Signaling), detectores | 2 semanas | $25M |
...
| 4.1.101 | Senalización LED | $720M | (sin cambio) |
...
1. `IX_WBS_Planificacion/WBS_Presupuestal_v2.0.md` → **v2.8** (Item 4.1.105, 4.1.106)
2. `V_Ingenieria_detalle/V.5_Pasos_Nivel_Detalle_v1.0.md` (Sección instalación PAN Tipo C)
3. `III_Ingenieria_conceptual/26_Pasos_Nivel_Seguridad_v1.0.md` (Sección 5.1 - Instalación)
4. `VIII_Documentos_Maestros_Metodologia/Matrices_Dependencias/MATRIZ_RIESGOS_PMO_AMPLIADA_v1.0.md` (R-070, R-071, R-072)
...
| Montaje equipos (barreras, senales) | 2 semanas | $25M | 12,5% |
...
| **PAN-C-05** | km 368 | Vía principal | Zona urbana Barrancabermeja (Puerto) |
