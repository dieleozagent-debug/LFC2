...
3. **Usar cable estándar 24 fibras (disponible)**
   ...
   - Desventajas: Menor capacidad, requiere más empalmes, NO cumple diseno
...
archivos_actualizar:
  ...
  - file: "IX_WBS_Planificacion/cronograma_datos.json"
