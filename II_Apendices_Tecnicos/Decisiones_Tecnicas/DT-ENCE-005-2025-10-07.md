...
| **Senalización de seguridad** | Banderas, conos, elementos de protección para operación manual | $1.200.000 |
...
4. **Senalización de seguridad:** Normativa ferroviaria exige elementos de protección específicos para operación manual en vía
...
| 1.5.101 | Senalización luminosa ENCE | 10 | $10.000.000 | $100.000.000 | (DT-ENCE-004) |
...
1. `IX_WBS_Planificacion/WBS_Presupuestal_v2.0.md` → **v2.5** (Item 1.5.102)
2. `VI_Operacion_Mantenimiento_Reversion/VI.2_Plan_Mantenimiento_v1.0.md` (Sección de herramientas)
3. `VIII_Documentos_Maestros_Metodologia/Matrices_Dependencias/MATRIZ_RIESGOS_PMO_AMPLIADA_v1.0.md` (R-022, R-051)
...
Archivos modificados: 4 (de 4 planificados)
  1. ✅ IX_WBS_Planificacion/WBS_Presupuestal_v2.0.md → v2.5
     - Item 1.5.102:
...
Notas adicionales:
  ...
  - Kit incluye: llave maniobra, calibradores, lubricantes, repuestos, caja IP65, senalización
```
...
| **HO-11** | Banderas de senalización | Roja + amarilla, mango telescópico | 2 | $400.000 |
