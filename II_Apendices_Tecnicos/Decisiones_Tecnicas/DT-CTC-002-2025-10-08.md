...
- ❌ Punto de Referencia Virtual (SICC) PTC VIRTUAL
...
#### **2. MÓDULO ENCLAVAMIENTOS VIRTUALES ($1,500M)**
   - **Integración con 5 ENCE físicos:**
     - Zapatosa, García Cadena, Barrancabermeja (Puerto)
...
#### **7. MÓDULO SEGURIDAD Y COMPLIANCE ($400M)**
   - **Cumplimiento normativo:**
     ...
     - Seguridad RAMS bajo FRA 236 Subpart I / PTCSP/50128/50129 (CENELEC)
...
- ✅ **Seguridad RAMS bajo FRA 236 Subpart I / PTCSP:** Especificación y demostración de RAMS
- ✅ **Seguridad de Software bajo FRA 49 CFR §236.1015 (PTCSP):2023:** Software para sistemas de control ferroviario
- ✅ **Seguridad Electrónica Vital bajo FRA/PTC (§236.1015):** Sistemas electrónicos de seguridad
...
| Software no cumple normativa | Baja | Alto | Certificación CENELEC Seguridad de Software bajo FRA 49 CFR §236.1015 (PTCSP):2023 obligatoria |
...
| **Valor Propuesto** | **APP La Dorada (México) - Chiriguaná** | **USD 2,000,000** | **$8,800,000,000** ✅ | **526 km** |
...
1. ✅ **Fabricantes certificados:**
   ...
   - [REDACTADO_SICC] (ICONIS)
   - Thales (TMS)
   - Bombardier Transportation (EBI Screen/EBI Lock)
   - Indra (Tráfico Centralizado)

2. ✅ **Certificaciones obligatorias:**
   - CENELEC Seguridad de Software bajo FRA 49 CFR §236.1015 (PTCSP):2023 (SIL-4 para software crítico)
   - CENELEC Seguridad Electrónica Vital bajo FRA/PTC (§236.1015) (sistemas electrónicos de seguridad)
...
3. ✅ **Garantías y soporte:**
   ...
   - Nivel 1, 2 y 3 con tiempos de respuesta:
     ...
     - Alto: < 4 horas
     - Medio: < 24 horas
   - Parches de seguridad: < 44 horas desde publicación CVE
...
**Archivo fuente:** `II_Apendices_Tecnicos/Decisiones_Tecnicas/DT-CTC-002-2025-10-08.md`
