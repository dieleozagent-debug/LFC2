...
#### **COMPONENTE 2: MÓDULO PTC VIRTUAL PTC VIRTUAL ($25,000,000,000 COP)**
...
- Gestión de handovers entre Servidor PTC Central
...
- §5.3: "Sistema CTC centralizado con disponibilidad 99.0%"
...
- §6.1: "Cumplimiento CENELEC Seguridad RAMS bajo FRA 236 Subpart I / PTCSP/128/129"
...
- **Disponibilidad:** 99.0% (43.4 horas downtime/ano)
...
archivos_actualizar:
  ...
  - file: "IX_WBS_Planificacion/wbs_metadata_enriquecida.json"
    ...
    metadata_actualizar:
      ...
      criterios_diseno:
        ...
        - "Alta Disponibilidad: $9.15B - Cluster N+1 + DR + 99.0%"
      supuestos:
  ...
  - file: "VIII_Documentos_Maestros_Metodologia/CRITERIOS_TECNICOS_MAESTRO_APP_La_Dorada_Chiriguaná_v1.0.md"
