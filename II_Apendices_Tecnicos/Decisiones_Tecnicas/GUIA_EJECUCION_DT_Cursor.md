...
4. Navega a: II_Apendices_Tecnicos/Decisiones_Tecnicas/
5. Pega el archivo
```
...
Move-Item "D:\Downloads\DT-FIBRA-042-2025-10-07.md" "II_Apendices_Tecnicos\Decisiones_Tecnicas\"
```
...
2. **Abrir archivo DT**
   ...
   - Método 2: File → Open → Navegar a `II_Apendices_Tecnicos/Decisiones_Tecnicas/DT-FIBRA-042-2025-10-07.md`
   - Método 3: Desde terminal:
     ```bash
     cursor "II_Apendices_Tecnicos\Decisiones_Tecnicas\DT-FIBRA-042-2025-10-07.md"
     ```
