...
Todas ellas incluyen sus respectivos equipos embarcados (“dispositivos tecnológicos”) para control de tráfico y senalización.
...
2. **8 unidades (5 + 3 reserva)** ⭐ SELECCIONADA
   ...
   - Distribución:
     ...
     - 2 para diseno/pruebas/validación
...
archivos_actualizar:
  ...
  - file: "IX_WBS_Planificacion/wbs_metadata_enriquecida.json"
    ...
    item_codigo: "1.2.100"
    metadata:
      justificacion_tecnica: "Cantidad 8 UND = 5 locomotoras contractuales (AT1: 2 GR12 + 2 U10 + 1 U18C) + 3 unidades de reserva (2 diseno/pruebas + 1 contingencia)"
